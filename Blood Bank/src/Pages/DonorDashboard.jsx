...
export default function DonorDashboard() {
  ...
  const fetchDonorData = async () => {
    try {
      ...
      if (donationsResponse) {
        // If response is { donations: [...] }, extract the array
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="rounded-lg border p-4">
            ...
            <div className="text-lg font-semibold">
              <span className={`px-2 py-1 rounded text-xs font-medium ${canDonate(donor.last_donation) ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'
                }`}>
        ...
        <div className="rounded-lg border p-4">
          ...
          {donor ? (
            <div className="space-y-2">
              ...
              <div><strong>Contact:</strong> {donor.contact_number}</div>
              ...
              {donor.last_donation && !canDonate(donor.last_donation) && (
                <div className="mt-2 p-2 bg-orange-50 border border-orange-200 rounded">
                  <div className="text-sm text-orange-800">
                    <strong>Next donation available:</strong> {
                      getNextDonationDate(donor.last_donation)?.toLocaleDateString()
                    }
                  </div>
                </div>
              )}
